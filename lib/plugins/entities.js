...
function inject (bot) {
  ...
  const Entity = require('reinarpg-entity')(bot.version)
  const Item = require('reinarpg-item')(bot.version)
  const ChatMessage = require('reinarpg-chat')(bot.registry)
  ...
  bot._client.on('entity_status', (packet) => {
    ...
    if (eventName === 'entityHandSwap' && entity.equipment) {
      ...
      entity.heldItem = entity.equipment[0] // Update held item like reinarpg-entity does upon equipment updates
    }
