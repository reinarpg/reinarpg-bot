...
const { OctahedronIterator } = require('reinarpg-world').iterators
...
function inject (bot, { version, storageBuilder, hideErrors }) {
  const Block = require('reinarpg-block')(bot.registry)
  const Chunk = require('reinarpg-chunk')(bot.registry)
  const World = require('reinarpg-world')(bot.registry)
